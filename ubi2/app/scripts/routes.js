 ...
 */
  ...
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .whenAuthenticated('/teamscape', {
        templateUrl: 'views/teamscape.html',
        controller: 'TeamscapeCtrl'
      })
      .whenAuthenticated('/projectDetails/:projectid', {
      ...
      .when('/agileBoard', {
        templateUrl: 'views/agileboard.html',
        controller: 'AgileboardCtrl',
        controllerAs: 'agileBoard'
      })
   ...
   */
  .run(['$rootScope', '$location', 'Auth', 'SECURED_ROUTES',
    function($rootScope, $location, Auth, SECURED_ROUTES) {
